...
One entry per slide: a clock, what to SAY (in the first person, conversational), what to DO, and
IF ASKED lines drawn from docs/CHECKIN_2026-09-10.md section 3. build_checkin_pptx.py writes each
entry into the slide's speaker notes above the builder's original one-line note; render_markdown()
writes the same script as docs/CHECKIN_2026-09-10_script.md for a phone or a printout.

Every number here is the number on the slide or in the brief; nothing is claimed beyond them.
"""
...
""",
    2: """[0:45-2:00]  STATUS ON THE TIMELINE
...
""",
    4: """[4:00-6:00]  TEN AXES, EACH WITH A REGISTERED AUTHORITY
...
""",
    5: """[6:00-10:00]  DELIVERED SINCE THE CHARTER, NEGATIVE RESULTS NAMED
...
""",
    6: """[10:00-12:30]  THE EMBODIMENT EXHIBIT: STRUCTURAL CONTAINMENT
...
""",
    7: """[12:30-14:00]  THE PIXELS NEVER DECIDE ALONE
...
""",
    8: """[14:00-18:00]  FIVE WEEKS TO MID-OCTOBER
...
""",
    9: """[18:00-22:00]  WHAT THE VERIFICATION DEMO WILL LOOK LIKE
...
""",
    10: """[22:00-30:00]  ASKS, THEN THEIR QUESTIONS
...
def render_markdown() -> str:
    out = ["# GTC Prototyping 1-1, 2026-09-10, 1:00-1:30 pm PT: presenter script", "",
           "Companion to `docs/CHECKIN_2026-09-10.md` (the brief) and `out/gtc_checkin_2026-09-10.pptx` "
           "(the deck; the same script is in each slide's speaker notes). Keep the deck as support; "
           "the check-in is a conversation.", "", "## Run of show", "", RUNSHEET, ""]
