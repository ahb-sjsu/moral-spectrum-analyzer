...
The Moral Spectrum Analyzer, Embodied. Companion to `out/gtc_checkin_2026-09-10.pptx` (the same script is in each slide's speaker notes), `GTC-Embodied-Governance-Plan.docx`, `twin/README.md` and `docs/CHECKIN_2026-09-10.md` (the brief, whose section 3 answers still apply to Pillar A). Keep the deck as support; the check-in is a conversation.
...
```
[2:15-4:15]  FROM JUDGING TEXT TO JUDGING ACTIONS
...
```
[4:15-6:00]  THE EVALUATOR INSIDE THE ROBOT
...
```
[6:00-7:45]  WHY ELEVATION IS THE SHARPEST DIMENSION
...
```
[7:45-10:15]  STRUCTURAL CONTAINMENT
...
```
[10:15-13:00]  EIGHT GOVERNANCE MOMENTS
...
```
[13:00-15:30]  THE PIXELS NEVER DECIDE ALONE
...
```
[15:30-17:30]  THE EVALUATOR'S OWN VALIDATION STANDS
...
```
[17:30-21:00]  FIVE WEEKS, AND THE EMBODIMENT MILESTONES
...
```
[21:00-23:00]  THE VERIFICATION DEMO
...
```
[23:00-30:00]  ASKS, THEN THEIR QUESTIONS
